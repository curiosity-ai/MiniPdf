...
<p>
<a href="README.md">English</a> | 简体中文 | <a href="documents/README.zh-TW.md">繁體中文</a> | <a href="documents/README.ja.md">日本語</a> | <a href="documents/README.ko.md">한국어</a> | <a href="documents/README.it.md">Italiano</a> | <a href="documents/README.fr.md">Français</a>
</p>
</div>
...
## 参考
- 使用 `Apache POI` + `LibreOffice` 训练参考小模型
- AI 开发使用 `GitHub Copilot` + `Claude Code`
...
MiniPdf 的输出与 MiniExcel 及 Office 365 作为参考渲染器进行对比，共 **373 个测试用例**。
...
- [Issue DOCX 文件报告](tests/Issue_Files/reports_docx/comparison_report.md) — 实际 Issue 文件测试用例

### 视觉对比

所有测试用例对比 MiniPdf 输出与 MiniExcel / Office 365 参考。多页结果仅显示第 1 页。

<table>
<tr><th>MiniPdf</th><th>MiniExcel / Office 365（参考）</th></tr>
<tr>
  <td><b>classic01</b></td>
...
MiniPdf DOCX 的输出与 MiniExcel 及 Office 365 作为参考渲染器进行对比，涵盖 **180 个经典测试用例**。
...
所有 DOCX 测试用例对比 MiniPdf 输出与 MiniExcel / Office 365 参考。多页结果仅显示第 1 页。
